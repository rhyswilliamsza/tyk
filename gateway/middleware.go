...
func (t BaseMiddleware) UpdateRequestSession(r *http.Request) bool {
	...
	lifetime := session.Lifetime(t.Spec.GetRespectKeyExpiration(), t.Spec.SessionLifetime, t.Gw.GetConfig().ForceGlobalSessionLifetime, t.Gw.GetConfig().GlobalSessionLifetime)
...
func (t BaseMiddleware) CheckSessionAndIdentityForValidKey(originalKey string, r *http.Request) (user.SessionState, bool) {
	...
	if found {
		...
		t.Logger().Debug("Lifetime is: ", session.Lifetime(t.Spec.GetRespectKeyExpiration(), t.Spec.SessionLifetime, t.Gw.GetConfig().ForceGlobalSessionLifetime, t.Gw.GetConfig().GlobalSessionLifetime))
