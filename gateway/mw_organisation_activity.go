...
func (k *OrganizationMonitor) ProcessRequestLive(r *http.Request, orgSession *user.SessionState) (error, int) {
	...
	sessionLifeTime := orgSession.Lifetime(k.Spec.RespectKeySessionLifetime, k.Spec.SessionLifetime, k.Gw.GetConfig().ForceGlobalSessionLifetime, k.Gw.GetConfig().GlobalSessionLifetime)
...
func (k *OrganizationMonitor) AllowAccessNext(
	...
	sessionLifeTime := session.Lifetime(k.Spec.RespectKeySessionLifetime, k.Spec.SessionLifetime, k.Gw.GetConfig().ForceGlobalSessionLifetime, k.Gw.GetConfig().GlobalSessionLifetime)
