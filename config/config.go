...
type Config struct {
	...
	// RespectKeyExpiration respects key expiration time when session lifetime is less than the key expiration. Redis waits the key expiration for physical removal.
